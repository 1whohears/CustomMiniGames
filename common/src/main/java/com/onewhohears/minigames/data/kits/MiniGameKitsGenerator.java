...
public class MiniGameKitsGenerator extends JsonPresetGenerator<GameKit> {
	...
	protected void registerPresets() {
		...
		addPresetToGenerate(GameKit.Builder.create(MiniGamesMod.MOD_ID, "standard")
				...
				.addItemRefill("minecraft:splash_potion", 2, healthPotionNbt)
				.addItemRefill("minecraft:cobblestone", 20)
				...
				.build());
		addPresetToGenerate(GameKit.Builder.create(MiniGamesMod.MOD_ID, "archer")
				.addItemKeep("minecraft:bow", true, true)
				.addItemKeep("minecraft:iron_axe", true)
				.addItemKeep("minecraft:iron_pickaxe", true)
				.addItemKeep("minecraft:iron_shovel", true)
				.addItemRefill("minecraft:bread", 32)
				.addItemKeep("minecraft:crossbow", true, true)
				...
				.build());
		addPresetToGenerate(GameKit.Builder.create(MiniGamesMod.MOD_ID, "builder")
				...
				.addItemRefill("minecraft:end_stone_bricks", 64)
				.addItemRefill("minecraft:cobblestone", 64)
				.addItemKeep("minecraft:shield", true)
	...
	public String getName() {
		return MiniGamesMod.MOD_ID +":"+MiniGameKitsManager.KIND;
	}
